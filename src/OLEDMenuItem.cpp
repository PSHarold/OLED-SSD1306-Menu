...
void OLEDMenuItem::calculate()
{
    ...
    if (this->str) {
        ...
        // but alignments would be off if using proportional fonts.
        // the calculated imageWidth will always be larger if using proportional fonts, and weird things will still happen,
        // so it's best just to use a monospaced font.)
